...
namespace ETForum.Migrations
{
    ...
    [Migration("20250617232529_notifikacije")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETForum.Models.Korisnik", b =>
                {
                    ...
                    b.Property<bool>("NotifKomentari")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifPoruke")
                        .HasColumnType("bit");

                    b.Property<bool>("NotifPrijateljstva")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ETForum.Models.PrivatniChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ETForum.Models.PrivatniChat", b =>
                {
                    b.HasOne("ETForum.Models.Korisnik", "posiljalac")
                        .WithMany()
                        .HasForeignKey("posiljalacId");

                    b.HasOne("ETForum.Models.Korisnik", "primaoc")
                        .WithMany()
